...
contextBridge.exposeInMainWorld('IO', {
  getFileListFromFTP: (host, directory) => ipcRenderer.invoke('getFileListFromFTP', host, directory),
  downloadFromHTTPS: (url, filename) => ipcRenderer.invoke('downloadFromHTTPS', url, filename),
  wgrib2: (gribfile) => ipcRenderer.invoke('wgrib2', gribfile)
});
